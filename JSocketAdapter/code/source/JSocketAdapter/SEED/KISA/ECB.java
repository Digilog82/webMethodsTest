...

{
	...
	final static ECB _instance = new ECB();

	static ECB _newInstance() { return new ECB(); }

	static ECB _cast(Object o) { return (ECB)o; }
	...
	public static final void SEED_ECB_Decrypt (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(SEED_ECB_Decrypt)>> ---
		// @sigtype java 3.5
		// [i] object:0:required pbszUserKey
		// [i] object:0:required pbData
		...
		byte[] pbData = ( byte[] )IDataUtil.get( pipelineCursor, "pbData" ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38
		int offset = IDataUtil.getInt( pipelineCursor, "offset", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38\uC758 \uC2DC\uC791 \uC624\uD504\uC14B
		int length = IDataUtil.getInt( pipelineCursor, "length", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38\uC758 byte \uAE38\uC774
	...
	public static final void SEED_ECB_Encrypt (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(SEED_ECB_Encrypt)>> ---
		// @sigtype java 3.5
		// [i] object:0:required pbszUserKey
		// [i] object:0:required pbData
		// [i] field:0:required offset
		...
		IDataCursor pipelineCursor = pipeline.getCursor();
		byte[] pbszUserKey = ( byte[] )IDataUtil.get( pipelineCursor, "pbszUserKey" ); // \uC0AC\uC6A9\uC790\uAC00 \uC9C0\uC815\uD558\uB294 \uBE44\uBC00\uD0A4 (16 bytes)
		byte[] pbData = ( byte[] )IDataUtil.get( pipelineCursor, "pbData" ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38
		int offset = IDataUtil.getInt( pipelineCursor, "offset", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38\uC758 \uC2DC\uC791 \uC624\uD504\uC14B
		int length = IDataUtil.getInt( pipelineCursor, "length", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38\uC758 byte \uAE38\uC774
		String endian = IDataUtil.getString( pipelineCursor, "endian" ); // byte Order
		pipelineCursor.destroy();

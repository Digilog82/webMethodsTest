%invoke JSocketAdapter.ADMIN:adminServerOnlineTraceLog%
...
<html>
	<head>		
		...
		<script language="javascript">
			function doAction(todo){
				...
				var portUnitName = frm.portUnitName.value;
				...
				var fileName = "OnlineTrace_" + portUnitName + "_" + logDate + ".log";
				frm.todo.value = todo;
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/socketlog-localonlinetrace.dsp">
		...
		<table class="tableForm" width="100%">
			...
			<tr>
				...
				<td class="evenrow-l" width="70%">
					<select name="portUnitName">
						%loop OnlinePortNumberList%
							<option value="%value onlinePortNumberValue%">%value onlinePortNumberDisplay%</option>
						%endloop%
					</select>
					<script language="javascript">
						document.pform.portUnitName.value = "%value portUnitName%";
					</script>
				</td>
			</tr>
			<tr>
		...
		<table class="tableForm" width="100%">
			<tr>
				<td class="heading">Online Trace Log</td>
			</tr>
			
			%loop onlineTraceLogList%
				<tr>
					<td>%value onlineTraceLogList%</td>
				</tr>
			%endloop%

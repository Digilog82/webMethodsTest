%invoke JSocketAdapter.ADMIN:adminDocSchemaDeploymentReservation%
...
<html>
	...
	<body onload="javascript:alertMsg()">		
			...
			<tr>
				%ifvar todo equals('read')%
					<td class="menusection-Settings" colspan="2">
						...
						Deploy Config &gt;
						Doc Schema Reservation &gt;
						Edit Doc Schema Reservation
					</td>
				%else%
					<td class="menusection-Settings" colspan="2">
						JSocketAdapter Package Home &gt;
		...
		%ifvar todo -notempty%
			<ul class="listitems">
				<li class="listitem"><a href="deploy-schemadeployreservation.dsp">Return to Doc Schema Reservation Information</a></li>
			</ul>
		%else%
		...
		<table class="tableForm" width="100%">	
			%ifvar todo equals('read')%
				<tr>
					<td class="heading" colspan="2">Doc Schema Deployment Reservation Schedule Properties</td>
				</tr>
				<tr>
			...
			%else%
				<tr>
					<td class="heading" colspan=5>Doc Schema Deployment Reservation Schedule Information</td>
				</tr>

%invoke JSocketAdapter.ADMIN:adminLocalServerSocketLog%
...
<html>
	<head>		
		...
		<script language="javascript">
			function doAction(todo){
				...
				var fileName = "SocketLog_" + portNumber + "_" + logDate + ".log";
				frm.todo.value = todo;
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/socketlog-localserver.dsp">

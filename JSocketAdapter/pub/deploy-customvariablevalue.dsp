...
<body onload="javascript:alertMsg()">
		...
		%ifvar deploy equals('remote')%
			...
			<ul class="listitems">
				<li class="listitem"><a href="deploy-customvariablevalue.dsp?deployClass=%value deployClass%&searchType=noDeploy&dupProcessType=notAdd">Return to Custom Variable Value Deployment Information</a></li>
			</ul>
			
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Custom Variable Value Deployment Result</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
       ...
       %endifvar%
		...
		%else%
			...
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Custom Variable Value Deployment</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="action" colspan="2">
						<input type="button" name="SUBMIT" value="Search Custom Variable Value"  onclick="return doAction('search')"></input>&nbsp;&nbsp;
						<input type="button" name="SUBMIT" value="Deploy Custom Variable Value"  onclick="return doAction('remote')"></input>
					</td>
				</tr>
			</table>
      ...
      <table class="tableView" width=100%>
        ...
        <tr class="subheading2">
				...
				%ifvar -notempty RegInfoList%
					...
					%endloop%
				%else%
					<tr><td colspan=4>No custom variable values to deploying are currently.</td></tr>
				%endifvar%
    	</table>
		%endifvar%
	</form>

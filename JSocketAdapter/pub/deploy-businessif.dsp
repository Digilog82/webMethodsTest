...
<title>Deploy Business Interface</title>
...
<body onload="javascript:alertMsg()">
		...
		%ifvar deploy equals('remote')%
			...
			<ul class="listitems">
				<li class="listitem"><a href="deploy-businessif.dsp?deployClass=%value deployClass%&searchType=noDeploy&dupProcessType=notAdd">Return to Business Doc Deployment Information</a></li>
			</ul>
			
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Business Doc Deployment Result</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
        	...
        	<tr>
						<td class="heading" colspan=5>Business Doc Information</td>
					</tr>
       ...
       %endifvar%
		...
		%else%
			...
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Business Doc Deployment</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="action" colspan="2">
						<input type="button" name="SUBMIT" value="Search Business Doc"  onclick="return doAction('search')"></input>&nbsp;&nbsp;
						<input type="button" name="SUBMIT" value="Deploy Business Doc"  onclick="return doAction('remote')"></input>
					</td>
				</tr>
			</table>
      ...
      <table class="tableView" width=100%>
        <tr>
			<td class="heading" colspan=8>Doc List Information in Business Name</td>
		</tr>
        <tr class="subheading2">
				...
				%ifvar -notempty RegInfoList%
					...
					%endloop%
				%else%
					<tr><td colspan=8>No business docs to deploying are currently.</td></tr>
				%endif%
    	</table>
		%endifvar%
	</form>

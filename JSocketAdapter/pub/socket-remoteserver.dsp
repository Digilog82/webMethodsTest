		...
		<script language="javascript">
			...
			*/
			...
			function applyDefaultName() {
				...
				var socketName = document.pform.name.value;
				var customerCode = "%value customerCode%";
				var topicName = "";
				var jmsTrgName = "";
				
				if (socketName == "") {
					alert("Socket Name을 먼저 입력하십시요.");
					return;
				}
				...
				if (customerCode == "HCC") { // 현대제철 냉연공장 전용 ==> 공장코드를 삽입한다.
					...
					topicName = "/topic/tcp/client/" + online + "/" + plantCode + "/" + socketName;
					jmsTrgName = "trgJMS_CLIENT_" + plantCode + "_" + socketName;
				} else {
					topicName = "/topic/tcp/client/" + online + "/" + socketName;
					jmsTrgName = "trgJMS_CLIENT_" + socketName;
				}
					...
					%ifvar -notempty ClientPortConfig/Ports%
						%loop ClientPortConfig/Ports%
							<tr>
								...
								%endifvar%
								<!-- 현대제철 냉연공장 전용 -->
								<td class="evenrowdata">%value systemName%</td>

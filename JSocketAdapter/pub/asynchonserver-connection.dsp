...
<html>
	...
	<body onload="javascript:alertMsg()">
		...
		%ifvar onlineList equals('true')%
			<ul class="listitems">
				<li class="listitem"><a href="asynchonserver-list.dsp?todo=search&searchPortNumber=%value searchPortNumber%&searchEnabled=%value searchEnabled%">Return to Online Server List Information</a></li>
			</ul>
		%endifvar%
		...
		<table class="tableForm" width="100%">
			...
			<tr>
				<td class="evenrow" width="30%">Listening</td>
				<td class="evenrow-l" width="70%">
					%value ServerPortInfo/listening%
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="evenrow" width="30%">Port Duplexing YN</td>
				<td class="evenrow-l" width="70%">
					%value ServerPortInfo/portDuplexing%
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="action" colspan="2">
					...
					%else%
						%ifvar ServerPortInfo/portDuplexing equals('No')%
							%ifvar ServerPortInfo/updateAvailable equals('true')%
								<input type="button" name="SUBMIT" value="Server Run"  onclick="return doAction('runningNo')"></input>
							%else%
								<input type="button" name="SUBMIT" value="Server Run"  onclick="return doAction('notAvailable')"></input>
							%endifvar%
						%else%
							<input type="button" name="SUBMIT" value="Server Run"  onclick="return doAction('runningNo')"></input>
						%endifvar%
		...
		%ifvar OutServerPortInfo -notempty%
			...
			<table class="tableForm" width="100%">
				...
				<tr>
					<td class="evenrow" width="30%">Listening</td>
					<td class="evenrow-l" width="70%">
						%value OutServerPortInfo/listening%
					</td>
				</tr>
				<tr>
					<td class="evenrow" width="30%">Port Number</td>

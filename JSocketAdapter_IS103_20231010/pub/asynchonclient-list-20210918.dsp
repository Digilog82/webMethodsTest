...
<html>
	...
	<body onload="javascript:alertMsg()">
		...
		<table class="tableForm" width="100%">	
			...
			<tr>
				<td class="heading" colspan="11">Online Client Socket Information</td>
			</tr>
			...
			%ifvar OnlineClientSocketInfoList -notempty%
				%loop OnlineClientSocketInfoList%
					%loop ClientPortInfoList -$index%
						...
						%ifvar $index equals(0)%
							...
							<td rowspan="%value ../clientCount%"><a href="javascript:doAction('read', '%value ../systemName%')">%value ../systemName%</a></td>
				...
				%endloop%
			%else%
				<tr><td colspan="11">No online remote server ports are currently registered.</td></tr>
			%endifvar%
		</table>
		</form>
	</body>

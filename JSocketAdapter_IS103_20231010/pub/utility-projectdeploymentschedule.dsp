%invoke JSocketAdapter.ADMIN:adminProjectDeploymentSchedule%
...
<html>
	...
	<body onload="javascript:alertMsg()">		
		...
		%ifvar todo -notempty%
			<ul class="listitems">
				<li class="listitem"><a href="utility-projectdeploymentschedule.dsp">Return to Project Deployment Reservation Schedule Information</a></li>
			</ul>
		%else%
		...
		<table class="tableForm" width="100%">	
			%ifvar todo equals('read')%
				<tr>
					<td class="heading" colspan="2">Project Deployment Reservation Schedule Properties</td>
				</tr>
				<tr>
			...
			%else%
				<tr>
					<td class="heading" colspan=5>Project Deployment Reservation Schedule Information</td>
				</tr>
				<tr class="subheading2">						
					<td>Deploy Project Names</td>
					<td>Run Time</td>
					<td>Status</td>
					<td>Edit</td>
					<td>Delete</td>
				...
				%ifvar -notempty onceTasks%
					...
					%endloop%
				%else%
					<tr><td colspan="5">No reservation schedules are currently registered.</td></tr>
				%endifvar%
			%endifvar%
		</table>
		</form>	

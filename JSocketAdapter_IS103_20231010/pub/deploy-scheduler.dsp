...
<body onload="javascript:alertMsg()">	
		...
		<div class="message">Target Server의 IS Administrator > Server > Scheduler 메뉴에서 Schedule이 Deploy 하기 전에 이미 생성되어 있어야 합니다.</div>
		...
		%ifvar deploy equals('remote')%
			...
			<ul class="listitems">
				<li class="listitem"><a href="deploy-scheduler.dsp?deployClass=%value deployClass%&searchType=noDeploy&dupProcessType=notAdd">Return to Online Check Schedule Deployment Information</a></li>
			</ul>
			
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Online Check Schedule Deployment Result</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
        	...
        	<tr>
						<td class="heading" colspan=5>Online Check Schedule Information</td>
					</tr>
       ...
       %endifvar%
		...
		%else%
			...
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Online Check Schedule Deployment</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="action" colspan="2">
						<input type="button" name="SUBMIT" value="Search Online Check Schedule"  onclick="return doAction('search')"></input>&nbsp;&nbsp;
						<input type="button" name="SUBMIT" value="Deploy Online Check Schedule"  onclick="return doAction('remote')"></input>
					</td>
				</tr>
			</table>
        ...
        <tr class="subheading2">
				...
				%ifvar -notempty RegInfoList%
					%loop RegInfoList -$index%
						<tr>
							<td class="evenrowdata"><input type="checkbox" name="selectedList%value $index%" value="%value service%">
							<td>%value service%</td>
					...
					%endloop%
				%else%
					<tr><td colspan=5>No online check schedules to deploying are currently.</td></tr>
				%endif%
    	</table>
		%endifvar%
	</form>

			...
			<tr name="DeployConfig_subMenu" style="display: none">
				<td class="menuitem"
					onmouseover="menuMouseOver(this, 'deploy-customvariablevalue.dsp');"
          				onmouseout="menuMouseOut(this);"
          				onclick="document.all['deploy-customvariablevalue.dsp'].click();"

				>
					<nobr>
						<img valign="middle" src="/WmRoot/images/blank.gif" width="4" height="1" border="0">
						<img valign="middle" id="deploy-customvariablevalue.dsp" name="deploy-customvariablevalue.dsp" src="/WmRoot/images/blank.gif" height="8" width="8" border="0">
						<a id="adeploy-customvariablevalue.dsp" target='body' href="deploy-customvariablevalue.dsp?deployClass=customVariableValue" onclick="moveArrow('deploy-customvariablevalue.dsp', 'body'); return true;"><span class="menuitemspan">Custom Variable Value</span>
						</a>
					</nobr>
				</td>
			</tr>
			...
			<tr name="DeployConfig_subMenu" style="display: none">
				<td class="menuitem"
					onmouseover="menuMouseOver(this, 'deploy-allconfig.dsp');"
          				onmouseout="menuMouseOut(this);"
          				onclick="document.all['deploy-allconfig.dsp'].click();"

				>
					<nobr>
						<img valign="middle" src="/WmRoot/images/blank.gif" width="4" height="1" border="0">
						<img valign="middle" id="deploy-allconfig.dsp" name="deploy-allconfig.dsp" src="/WmRoot/images/blank.gif" height="8" width="8" border="0">
						<a id="adeploy-allconfig.dsp" target='body' href="deploy-allconfig.dsp" onclick="moveArrow('deploy-allconfig.dsp', 'body'); return true;"><span class="menuitemspan">All Config</span>
						</a>
					</nobr>
				</td>
			</tr>
			...
			<tr name="AS400_subMenu" style="display: none">
				<td class="menuitem"
					onmouseover="menuMouseOver(this, 'as400-reconnectlistener.dsp');"
          				onmouseout="menuMouseOut(this);"
          				onclick="document.all['as400-reconnectlistener.dsp'].click();"

				>
					<nobr>
						<img valign="middle" src="/WmRoot/images/blank.gif" width="4" height="1" border="0">
						<img valign="middle" id="as400-reconnectlistener.dsp" name="as400-reconnectlistener.dsp" src="/WmRoot/images/blank.gif" height="8" width="8" border="0">
						<a id="aas400-reconnectlistener.dsp" target='body' href="as400-reconnectlistener.dsp?enable=search" onclick="moveArrow('as400-reconnectlistener.dsp', 'body'); return true;"><span class="menuitemspan">Reconnect Listener</span>
						</a>
					</nobr>
				</td>
			</tr>
			...
			<tr name="AS400_subMenu" style="display: none">
				<td class="menuitem"
					onmouseover="menuMouseOver(this, 'as400-reservationschedule.dsp');"
          				onmouseout="menuMouseOut(this);"
          				onclick="document.all['as400-reservationschedule.dsp'].click();"

				>
					<nobr>
						<img valign="middle" src="/WmRoot/images/blank.gif" width="4" height="1" border="0">
						<img valign="middle" id="as400-reservationschedule.dsp" name="as400-reservationschedule.dsp" src="/WmRoot/images/blank.gif" height="8" width="8" border="0">
						<a id="aas400-reservationschedule.dsp" target='body' href="as400-reservationschedule.dsp" onclick="moveArrow('as400-reservationschedule.dsp', 'body'); return true;"><span class="menuitemspan">Deployment Reservation</span>
						</a>
					</nobr>
				</td>
			</tr>

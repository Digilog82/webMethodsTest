%invoke JSocketAdapter.ADMIN:adminRemoteServerSocketLog%
...
<html>
	<head>		
		...
		<script language="javascript">
			function doAction(todo){
				...
				var fileName = "SocketLog_" + socketName + "_" + logDate + ".log";
				frm.todo.value = todo;
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/socketlog-remoteserver.dsp">
		...
		<table class="tableForm" width="100%">
				<tr>
					<td class="heading">Socket Log</td>
				</tr>
				
				%loop socketLogList%
						<tr>
							<td>%value socketLogList%</td>
						</tr>
				%endloop%
			</table>
		</form>

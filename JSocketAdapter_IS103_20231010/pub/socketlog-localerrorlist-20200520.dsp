...
<html>
	...
	<body>
		...
		<table class="tableForm" width="100%">
			<tr>
				<td class="heading" colspan=5>Local Server Error Log (총 조회 건수 : %value searchCount%)</td>
			</tr>
			...
			%ifvar -notempty SocketAuditInfoList%			
				%loop SocketAuditInfoList%
					<tr>
						...
						<td><a href="javascript:doAction('read', '', '%value fullFileName%')">%value auditStartTime%</a></td>
						<td>%value docID%</td>
			...
			%else%
				<tr><td colspan=5>No local server error logs are currently saved.</td></tr>
			%endifvar%
		</table>				
		</form>		
	</body>

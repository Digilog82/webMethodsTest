		...
		<script language="javascript">
			function doAction(todo) {				
				...
				if (todo == 'search') {
					...
					if (document.pform.selectedList.value == "") {
						alert("Deploy할 Business Name을 선택하십시요!!!");
						return;
					} else {
						document.pform.submit();
					}
...
<body onload="javascript:alertMsg()">
		...
		%ifvar deploy equals('remote')%
			...
			<ul class="listitems">
				<li class="listitem"><a href="deploy-businessname.dsp?deployClass=%value deployClass%&searchType=noDeploy&dupProcessType=notAdd">Return to Business Name Deployment Information</a></li>
			</ul>
			
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Business Name Deployment Result</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
       ...
       %endifvar%
		...
		%else%
			...
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Business Name Deployment</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="action" colspan="2">
						<input type="button" name="SUBMIT" value="Search Business Name"  onclick="return doAction('search')"></input>&nbsp;&nbsp;
						<input type="button" name="SUBMIT" value="Deploy Business Name"  onclick="return doAction('remote')"></input>
					</td>
				</tr>
			</table>
      ...
      <table class="tableView" width=100%>
        <tr>
					<td class="heading" colspan=6>Business Name Information</td>
				</tr>
        <tr class="subheading2">
				...
				%ifvar -notempty RegInfoList%
					...
					%endloop%
				%else%
					<tr><td colspan=6>No business names to deploying are currently.</td></tr>
				%endif%
    	</table>
		%endifvar%
	</form>

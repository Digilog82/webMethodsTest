%invoke JSocketAdapter.ADMIN:adminServerLog%
...
<html>
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/utility-serverlog.dsp">
		...
		<table class="tableForm" width="100%">
			<tr>
				<td class="heading" colspan="2">Server Log Properties</td>
			</tr>
			<tr>
		...
		<table class="tableForm" width="100%">
				<tr>
					<td class="heading">Server Log</td>
				</tr>
				
				%loop serverLogList%
						<tr>
							<td>%value serverLogList%</td>
						</tr>
				%endloop%
			</table>
		</form>

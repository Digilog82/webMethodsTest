%invoke JSocketAdapter.ADMIN:adminToggleDataQListenerHC%
...
<body onload="javascript:alertMsg()">
		...
		<div class="message">AS400 연계 환경에 따라서 JSocketAdapter.DQLISTENER:healthCheckListener 서비스 Customizing이 필요합니다.</div>
      ...
      <table class="tableView" width=100%>
        <tr><td class="heading" colspan=4>AS400 Data Q Listeners Health Check Schedule Create/Active/Suspend</td></tr>

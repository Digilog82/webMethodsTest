...
<html>
	...
	<body onload="javascript:alertMsg()">
		<!-- 수정처리 후 Business Name 상세조회 및 Business Interface List 조회 화면으로 이동 -->
		%ifvar todo equals('update')%
		...
		<table class="tableForm" width="100%">	
			...
			<tr>
				...
				<tr>
					...
					<td class="oddrowdata-l" width="70%"><input type="text" name="name" value="%value name%" size="20" style="font-size:10pt;width:400">&nbsp;(Fixed Length 4)</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="evenrowdata-l" width="70%"><input type="text" name="qName" value="%value qName%" size="20" style="font-size:10pt;width:400">&nbsp;(AS400 System Business)</td>
				</tr>
				<tr>
					<td class="oddrowdata-r" width="30%">Receive Data Q Key Length</td>
					<td class="oddrowdata-l" width="70%"><input type="text" name="keyLength" value="%value keyLength%" size="20" style="font-size:10pt;width:400">&nbsp;(bytes)&nbsp;(AS400 System Business)</td>
				</tr>
				<tr>
					<td class="evenrowdata-r" width="30%">Description</td>
					<td class="evenrowdata-l" width="70%"><input type="text" name="description" value="%value description%" size="20" style="font-size:10pt;width:400"></td>
				</tr>
				<tr>

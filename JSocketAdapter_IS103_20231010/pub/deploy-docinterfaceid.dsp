...
<body onload="javascript:alertMsg()">
		...
		%else%
		<div class="message">Target Server에서 Doc에 대한 정보가 다를 경우 Deploy 한 후에 Target Server에서 직접 수정을 해야 합니다.</div>
		%endifvar%
		...
		%ifvar deploy equals('remote')%
			...
			<ul class="listitems">
				<li class="listitem"><a href="deploy-docinterfaceid.dsp?deployClass=%value deployClass%&searchType=noDeploy&dupProcessType=notAdd">Return to Interface Doc Deployment Information</a></li>
			</ul>
			
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Interface Doc Deployment Result</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
        	...
        	<tr>
						<td class="heading" colspan=5>Interface Doc Information</td>
					</tr>
       ...
       %endifvar%
		...
		%else%
			...
			<table class="tableForm" width="100%">
				<tr>
					<td class="heading" colspan="2">Interface Doc Deployment</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="action" colspan="2">
						<input type="button" name="SUBMIT" value="Search Interface Doc"  onclick="return doAction('search')"></input>&nbsp;&nbsp;
						<input type="button" name="SUBMIT" value="Deploy Interface Doc"  onclick="return doAction('remote')"></input>
					</td>
				</tr>
			</table>

<html>
	...
	<frameset rows="50,*" border="0" framespacing="0" spacing="0" frameborder="0">
		...
		<frameset cols="200,*" border="0" framespacing="0" spacing="0" frameborder="0">
			<frame src="menu.dsp" marginwidth="5" marginheight="5" name="menu" scrolling="auto" seamless="seamless">
			<frame src="basic-about.dsp" marginwidth="0" marginheight="0" name="body">
		</frameset>
	</frameset>
	<noframes>
		<body>

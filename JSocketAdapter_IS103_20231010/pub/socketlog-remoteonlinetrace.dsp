%invoke JSocketAdapter.ADMIN:adminClientOnlineTraceLog%
...
<html>
	<head>		
		...
		<script language="javascript">
			function doAction(todo){
				...
				var fileName = "OnlineTrace_" + socketUnitName + "_" + logDate + ".log";
				frm.todo.value = todo;
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/socketlog-remoteonlinetrace.dsp">

%invoke JSocketAdapter.ADMIN:adminDQChangeSchedule%
...
<html>
	...
	<body onload="javascript:alertMsg()">
			...
			<tr>
				%ifvar todo equals('read')%
					<td class="menusection-Settings" colspan="2">
						...
						AS/400 &gt;
						Queue Change Reservation &gt;
						Edit Queue Change Reservation
					</td>
				%else%
					<td class="menusection-Settings" colspan="2">
						JSocketAdapter Package Home &gt;
		...
		%ifvar todo -notempty%
			<ul class="listitems">
				<li class="listitem"><a href="as400-changedqschedule.dsp">Return to Queue Change Reservation Schedule Information</a></li>
			</ul>
		%else%
		...
		<table class="tableForm" width="100%">	
			%ifvar todo equals('read')%
				<tr>
					<td class="heading" colspan="2">Queue Change Reservation Schedule Properties</td>
				</tr>
				<tr>
					<tr>
			...
			%else%
				<tr>
					<td class="heading" colspan=6>Queue Change Reservation Schedule Information</td>
				</tr>

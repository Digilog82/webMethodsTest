%invoke JSocketAdapter.ADMIN:adminMailNotificationLog%
...
<html>
	<head>		
		...
		<script language="javascript">
			function doAction(todo){
				...
				var fileName = "MailNotiLog_" + logDate + ".log";
				frm.todo.value = todo;
	...
	<body onload="javascript:alertMsg()">
		...
		<form name="pform" method="post" target="_self">
			...
			<input type="hidden" name="moveAction" value="/JSocketAdapter/socketlog-mailnoti.dsp">
		...
		<table class="tableForm" width="100%">
				<tr>
					<td class="heading">Mail Notification Log</td>
				</tr>
				
				%loop mailNotiLogList%
						<tr>
							<td>%value mailNotiLogList%</td>
						</tr>
				%endloop%
			</table>
		</form>

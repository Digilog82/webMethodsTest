package JSocketAdapter.SEED.KISA;
...

{
	...
	final static CBC _instance = new CBC();

	static CBC _newInstance() { return new CBC(); }

	static CBC _cast(Object o) { return (CBC)o; }
	...
	public static final void SEED_CBC_Decrypt (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(SEED_CBC_Decrypt)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		// [i] object:0:required pbszUserKey
		// [i] object:0:required pbszIV
		// [i] object:0:required message
		// [i] field:0:required message_offset
		// [i] field:0:required message_length
		// [i] field:0:required endian {"BIG_ENDIAN","LITTLE_ENDIAN"}
		// [o] object:0:required pbszPlainText
		IDataCursor pipelineCursor = pipeline.getCursor();
		byte[] pbszUserKey = ( byte[] )IDataUtil.get( pipelineCursor, "pbszUserKey" ); // \uC0AC\uC6A9\uC790\uAC00 \uC9C0\uC815\uD558\uB294 \uBE44\uBC00\uD0A4 (16 bytes)
		byte[] pbszIV = ( byte[] )IDataUtil.get( pipelineCursor, "pbszIV" ); // \uC0AC\uC6A9\uC790\uAC00 \uC9C0\uC815\uD558\uB294 \uCD08\uAE30\uD654 \uBCA1\uD130 (16 bytes)
		byte[] message = ( byte[] )IDataUtil.get( pipelineCursor, "message" ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38
		int message_offset = IDataUtil.getInt( pipelineCursor, "message_offset", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38\uC758 \uC2DC\uC791 \uC624\uD504\uC14B
		int message_length = IDataUtil.getInt( pipelineCursor, "message_length", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uC554\uD638\uBB38\uC758 byte \uAE38\uC774
		String endian = IDataUtil.getString( pipelineCursor, "endian" ); // byte Order
		...
		if ( SEED_CBC_Close( info, outbuf, ( nRetOutLeng[ 0 ] ), nPaddingLeng ) == 1 ) {
			...
			result = new byte[ pdmessage_length ];
		...
		IDataUtil.put( pipelineCursor_1, "pbszPlainText", result );
	...
	public static final void SEED_CBC_Encrypt (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(SEED_CBC_Encrypt)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		// [i] object:0:required pbszUserKey
		// [i] object:0:required pbszIV
		...
		// [i] field:0:required message_length
		// [i] field:0:required endian {"BIG_ENDIAN","LITTLE_ENDIAN"}
		// [o] object:0:required pbszCipherText
		IDataCursor pipelineCursor = pipeline.getCursor();
		byte[] pbszUserKey = ( byte[] )IDataUtil.get( pipelineCursor, "pbszUserKey" ); // \uC0AC\uC6A9\uC790\uAC00 \uC9C0\uC815\uD558\uB294 \uBE44\uBC00\uD0A4 (16 bytes)
		byte[] pbszIV = ( byte[] )IDataUtil.get( pipelineCursor, "pbszIV" ); // \uC0AC\uC6A9\uC790\uAC00 \uC9C0\uC815\uD558\uB294 \uCD08\uAE30\uD654 \uBCA1\uD130 (16 bytes)
		byte[] message = ( byte[] )IDataUtil.get( pipelineCursor, "message" ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38
		int message_offset = IDataUtil.getInt( pipelineCursor, "message_offset", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38\uC758 \uC2DC\uC791 \uC624\uD504\uC14B
		int message_length = IDataUtil.getInt( pipelineCursor, "message_length", 0 ); // \uC0AC\uC6A9\uC790 \uC785\uB825 \uD3C9\uBB38\uC758 byte \uAE38\uC774
		String endian = IDataUtil.getString( pipelineCursor, "endian" ); // byte Order
		pipelineCursor.destroy();
		...
		IDataCursor pipelineCursor_1 = pipeline.getCursor();
		IDataUtil.put( pipelineCursor_1, "pbszCipherText", pbszCipherText );
		pipelineCursor_1.destroy();
		// --- <<IS-END>> ---
	...
	private static void setEndian( String endian ) {
		if ( endian == null || endian.equals( "" ) || endian.equals( "BIG_ENDIAN" ) ) {
			ENDIAN = Common.BIG_ENDIAN;
		} else {
			ENDIAN = Common.LITTLE_ENDIAN;
		}
	}

...
<SCRIPT>
    ...
    function updateSecret(operation,id){
        document.forms['oAuthClientRegForm'].operation.value="update-secret";
    }
  ...
  <TABLE WIDTH="100%">
            ...
            <TD width="70%">
                ...
                <TABLE WIDTH="100%" class="tableView">
                    ...
                    %ifvar type equals('confidential')%
                    <TR>
                       <TD class="evenrow" nowrap><label for="client_secret"></label></TD>
                            <TD  class="action" >
                            <input type="submit" name="submit" value="Generate New Secret" onclick="return updateSecret('update-secret','%value client_id encode(javascript)%');">
                       </TD>
                    </TR>
                    %endif%
                    %endif%

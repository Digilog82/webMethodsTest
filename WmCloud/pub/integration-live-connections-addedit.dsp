...
%endif%
        ...
        %endif%
          ...
          <TR>
            ...
            <TR>
            			<TD class="evenrow" nowrap><label for="timeToLiveCache">Enable Compression</label></TD>
                  <TD class="evenrow-l">
                    %ifvar action equals('edit')%
                    	%ifvar enableCompression equals('true')%
		                   <INPUT TYPE="CHECKBOX" NAME="enableCompression" id="enableCompression"  CHECKED="true">
		                %else%
						   %ifvar enableCompression equals('on')%
								<INPUT TYPE="CHECKBOX" NAME="enableCompression" id="enableCompression"  CHECKED="true">
							%else%	
		                   <INPUT TYPE="CHECKBOX" NAME="enableCompression" id="enableCompression">
						   %endif%
		                %endif%   
                    %else%
						%ifvar enableCompression equals('on')%
